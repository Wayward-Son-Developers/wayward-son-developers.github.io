...
## Snitz Forums (as [AnonJr](https://forum.snitz.com/forum/Account/Detail/AnonJr))
![Snitz Logo]({{ "/img/logo-snitzforums.gif" | absolute_url }}){: class="logo-img"} Back in 2004, my boss asked me to integrate a support forum into our <acronym title="Learning Management System">LMS</acronym>. Since the system was written in [ASP Classic](https://en.wikipedia.org/wiki/Active_Server_Pages), I looked through my options and settled on [Snitz Forums](https://forum.snitz.com/). From July 2005 on until development work on the LMS halted, I'd been an active member in the [support forums](https://forum.snitz.com/forum/AllForums) for this project - helping others, contributing various extensions, and working with the core dev team on the 3.4.07 release.
...
## Stack Overflow (as [AnonJr](http://stackoverflow.com/users/25163/anonjr))
<a href="https://stackexchange.com/users/12701/anonjr"><img src="https://stackexchange.com/users/flair/12701.png" width="208" height="58" alt="profile for AnonJr on Stack Exchange, a network of free, community-driven Q&amp;A sites" title="profile for AnonJr on Stack Exchange, a network of free, community-driven Q&amp;A sites" class="logo-img" /></a> While not strictly "project" like the previous entries, it's worth mentioning here as it was something I've contributed code to.
